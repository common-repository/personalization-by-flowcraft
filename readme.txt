...
Plugin Name:       Advanced Personalization
Plugin URI:        https://personalizationwp.com/
Tags:              Personalization, dynamic content, martketing tool, user experience, behaviour, create shortcode, content personalisation, WordPress plugin, flowcraft, website customization, website personalization, conditional content, Real-time personalization, show content on scroll, time & date, returning visitor, new visitor , specific page, when user leaves, smart site, custom website, custom content, customisation, conversion, dynamic web content, geolocation, user location, country,
...
The advanced Personalization plugin by Flowcraft UX Design Studio will certainly help you improve conversions, sell more and increase revenue and profits by personalizing parts of your site for different user audiences, based on certain characteristics of the users.
...
2. Create condition
3. How it works
4. Choose and combine your condition rules
5. Choose and combine more condition rules
6. Show content when condition is met
7. Publish and get your shortcode
...
= 1.2.2 =
* Fix: Overloading users' cache causing 400 Error Bad request
